import type { TeamQuizQuestion, TeamQuizResult } from '../types';

// Auto-extracted from original App.jsx

export const TEAM_QUIZ_QUESTIONS: TeamQuizQuestion[] = [
  {
...
export const TEAM_QUIZ_RESULTS: Record<string, TeamQuizResult> = {
